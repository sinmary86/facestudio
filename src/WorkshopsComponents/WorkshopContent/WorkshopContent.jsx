  ...
  return (
    ...
    <Container className={styles.myGridSection}>
        ...
        <div className={styles.gridLayout} >
            ...
            <p>Ateliers dynamiques en groupe, où nous analysons pourquoi le visage paraît fatigué, pourquoi vous ne reconnaissez plus votre reflet dans le miroir, et nous apprenons des techniques simples qui redonnent à la peau fraîcheur et éclat.</p>
            </div>
            
            <div className={styles.textBlockTwo}>
            <p>Format : en ligne ou en présentiel <br/>
               Durée : 1 – 2 h (selon le thème)</p>
            </div>
            ...
            <h5 className={styles.quoteText}>Tensions faciales, poches sous les yeux, front froncé — c’est le langage du corps. Lors de l’atelier, nous traduirons ce langage en mots simples et vous donnerons des astuces utiles.</h5>
            </div>
            ...
            <div className={styles.textTallRight}>
              ...
              <p>Sprint de drainage lymphatique + comment se réveiller sans poches ni œdèmes</p>

              <h4>Comment relâcher les tensions faciales et lisser le visage </h4>
              <p>Éliminer les grimaces réflexes tout en gardant une expression vivante</p>

              <h4>Front & regard : liberté de la zone supérieure </h4>
              <p>Respiration, pleine conscience et automassage pour un regard ouvert et apaisé</p>
            </div>
