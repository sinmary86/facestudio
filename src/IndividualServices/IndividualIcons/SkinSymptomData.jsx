...
export const SkinSymptomData = [
  {
    description:(
    <>
      Des rides et de fines  {" "}<span className="d-none d-md-inline"><br /></span>
  ...
  },
  {
    description:(
      <>
      La peau perd en fermeté, {" "}<span className="d-none d-md-inline"><br /></span>
  ...
  },
  {
    description:(
      <>
      Le visage devient  {" "}<span className="d-none d-md-inline"><br /></span>
